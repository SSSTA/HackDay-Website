{% extends "base.tpl" %}
{% block title %}
<title>详细介绍 - SSSTA Hackday</title>
{% endblock %}
{% block content %}
    ...
    <section id="services" >
        ...
        <div class="row no-bottom-margin">
            <section class="col" id="main" name="main">
                ...
                <p class="intro">&nbsp;&nbsp;&nbsp;&nbsp;当前在全球范围内，有<strong>Hack Day</strong>性质的活动，比如在豌豆实验室，每年都有一两天的时间，所有的豌豆们都会放下手上的正经工作，打乱原有的分工，组成一个个新团队，开始做一些稀奇古怪、看起来跟平常做的一点关系也没有的产品。</p>
                ...
                <hr/>
                <ul>
                    <li><strong>最佳作品奖</strong>，奖金<strong>4000</strong>元或等价值奖品一份</li>
                    <li><strong>最佳技术奖</strong>，奖金<strong>2000</strong>元或等价值奖品一份</li>
                    <li><strong>最佳创意奖</strong>，奖金<strong>2000</strong>元或等价值奖品一份</li>
                    <li><strong>最佳设计奖</strong>，奖金<strong>2000</strong>元或等价值奖品一份</li>
                    <li><strong>参与奖</strong>，<strong>纪念T恤</strong>一件</li>
                </ul>
                <h2>比赛规则</h2>
                <hr/>
                <ul>
